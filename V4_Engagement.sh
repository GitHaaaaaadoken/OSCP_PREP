...
wget https://github.com/borjmz/aspx-reverse-shell/archive/refs/heads/master.zip -O OSCP/WebStuff/aspx-rev-shell.zip

cp /usr/share/webshells/aspx/cmdasp.aspx OSCP/WebStuff/
...
# MIBs stuff for SNMP ENUMERATION
...
wget https://github.com/unode/firefox_decrypt/archive/refs/heads/main.zip -P OSCP/WebStuff 


### Install PSSPY 64bit and 32bit (static versions)

wget https://github.com/DominicBreuker/pspy/releases/download/v1.2.1/pspy64 -P OSCP/GeneralEnumeration/

wget https://github.com/DominicBreuker/pspy/releases/download/v1.2.1/pspy32 -P OSCP/GeneralEnumeration/


### Download VNCPasswd.py to help decrypt passwords 

wget https://github.com/trinitronx/vncpasswd.py/archive/refs/heads/master.zip -O OSCP/vncpassPY.zip
